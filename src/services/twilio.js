...
import { eventBus } from '../infra/bus.js';
...
import { getVoiceId, AGENT_GREETINGS } from '../domain/fallbacks.js';
...
export async function handleConference(req, res) {
    ...
    const { BusOps, getTaskContext, getTaskTranscript } = await import('../infra/bus.js');
